    ...
    <div className='footer'>
      <div className='footersection-padding'>
        ...
        <span class="placeholder">Enter your email</span>
            ...
            <a class="btn4 btn-border-3" href="">Subscribe</a>
